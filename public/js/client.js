...
=======
  SOCKET.on('newmine', function(data){
    ...
    mines.push(temp);
>>>>>>> e3dc2f50110fca257ab84e27d490ddd41e829f87
  });
...
//Create joystick inside of #dynamic div of color blue
var joystick = nipplejs.create({
  zone: document.getElementById('dynamic'),
  color: 'blue'
});

//Whenever the joystick moves to any of the four directions
joystick.on('dir:up dir:left dir:down ' +
  'dir:right',
  function (evt, data) {
    //Check which direction the joystick is facing and move accordingly
